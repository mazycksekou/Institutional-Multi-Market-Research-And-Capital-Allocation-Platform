...
def test_project_status_governance_files_exist_and_are_canonical() -> None:
    ...
    assert "active checkpoint: `Portfolio Exposure and Incremental Risk`" in project_status_text
    ...
    assert "do not reimplement completed static covariance" in next_action_text.lower()
