...
from src.automation_scheduler_legacy.data_source_registry import MANDATORY_LANES, build_registry_report
...
class TestDataSourceRegistry(unittest.TestCase):
    ...
    def test_source_shape_and_safety_flags(self):
        ...
        for key in (
            ...
            "verification_phase_allowed",
            "requires_budget_approval",
            "call_budget_level",
            "max_provider_calls_default",
            "max_provider_calls_hard_cap",
            "paid_upgrade_required",
            "paid_upgrade_allowed",
            "substantial_usage_allowed",
