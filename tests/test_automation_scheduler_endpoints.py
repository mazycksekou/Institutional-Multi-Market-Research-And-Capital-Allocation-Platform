...
class TestAutomationSchedulerEndpoints(unittest.TestCase):
    ...
    def test_deepseek_review_endpoint_compact_default(self):
        with patch(
            "src.services.automation_scheduler_facade.run_automation_deepseek_review",
            return_value={
                "ok": True,
                "status": "disabled",
                "enabled": False,
    ...
    def test_deepseek_red_team_endpoint_compact_default(self):
        with patch(
            "src.services.automation_scheduler_facade.run_automation_deepseek_red_team",
            return_value={
                "ok": True,
    ...
    def test_deepseek_disagreements_endpoint_compact_default(self):
        with patch(
            "src.services.automation_scheduler_facade.get_deepseek_disagreements",
            return_value={
                "ok": True,
                "status": "ok",
    ...
    def test_deepseek_daily_report_endpoint_compact_default(self):
        with patch(
            "src.services.automation_scheduler_facade.get_deepseek_daily_report",
            return_value={
                "ok": True,
                "status": "disabled",
                "enabled": False,
    ...
    def test_institutional_lab_run_endpoint_compact_default(self):
        with patch(
            "src.services.automation_scheduler_facade.run_institutional_lab",
            return_value={
                "ok": True,
                "status": "completed",
                "run_id": "run-1",
    ...
    def test_institutional_execution_simulation_endpoint_accepts_simulation_only(self):
        with patch(
            "src.services.automation_scheduler_facade.simulate_institutional_execution",
            return_value={
                "ok": True,
                "status": "simulated",
    ...
    def test_institutional_deepseek_endpoint_disabled_does_not_crash(self):
        with patch(
            "src.services.automation_scheduler_facade.run_institutional_deepseek_review",
            return_value={
                "ok": True,
                "status": "disabled",
                "enabled": False,
    ...
    def test_institutional_report_and_audit_endpoints_compact(self):
        with patch("src.services.automation_scheduler_facade.get_institutional_lab_report", return_value={"ok": True, "status": "not_run"}):
            report = self.client.get("/api/automation/institutional-lab/report")
        self.assertEqual(report.status_code, 200)
        self.assertFalse(report.json()["provider_write"])
        with patch(
            "src.services.automation_scheduler_facade.get_institutional_lab_audit",
