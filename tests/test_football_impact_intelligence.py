...
from src.analytics.football_impact_report import build_football_impact_diagnostics
...
from src.market_intelligence.response_compactor import compact_football_impact_diagnostics_response
