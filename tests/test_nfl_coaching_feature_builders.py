...
from src.automation_scheduler_legacy.nfl_coaching_adapters import ManualCsvCoachingImportAdapter
from src.services.streamlit_dashboard_facade import coaching_source_by_id
from src.automation_scheduler_legacy.nfl_coaching_feature_builders import COACHING_FEATURE_BUILDERS, build_coordinator_continuity_candidates, build_nfl_coaching_feature_report, build_nfl_coaching_acquisition_report, build_nfl_coaching_features, write_nfl_coaching_acquisition_report
