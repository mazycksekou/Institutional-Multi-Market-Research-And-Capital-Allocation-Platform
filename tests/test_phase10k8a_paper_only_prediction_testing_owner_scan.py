...
REPORT_PATH = Path("PHASE10K8A_PAPER_ONLY_PREDICTION_TESTING_OWNER_SCAN.md")
...
def test_phase10k8a_report_exists_and_contains_required_strings() -> None:
    assert REPORT_PATH.exists(), "10K8A report is missing"
