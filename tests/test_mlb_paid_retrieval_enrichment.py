...
class TestMlbPaidRetrievalEnrichment(unittest.TestCase):
    def test_paid_mode_reports_enabled_count(self):
        report = build_paid_retrieval_enrichment_report(sport="mlb", allow_oxylabs=True, allow_paid_retrieval=True)
