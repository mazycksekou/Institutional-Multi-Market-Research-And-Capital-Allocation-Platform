...
def test_production_activation_checkpoint_docs_exist_and_describe_status() -> None:
    docs = [
...
def test_production_activation_checkpoint_imports_safely_and_keeps_live_disabled(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    assert kill_switch.require_kill_switch_clear(clear_kill_switch) == clear_kill_switch
