...
def test_no_legacy_data_backtesting_files_were_deleted() -> None:
    for relative in [
        'src/automation_scheduler_legacy/backtesting_engine.py',
        'src/automation_scheduler_legacy/backtest_dataset_builder.py',
        'src/automation_scheduler_legacy/backtest_schema.py',
        'src/automation_scheduler_legacy/backtest_leakage.py',
        'src/automation_scheduler_legacy/backtest_strategy_bankroll.py',
        'src/automation_scheduler_legacy/backtest_strategy_profiles.py',
        'src/automation_scheduler_legacy/historical_data_sources.py',
        'src/automation_scheduler_legacy/historical_odds_importers.py',
