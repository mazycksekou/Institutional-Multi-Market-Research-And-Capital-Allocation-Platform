...
REPORT_PATH = REPO_ROOT / "PHASE10K8K_PREDICTION_TESTING_READINESS_REVIEW.md"
REPORT_FILES = [
    REPO_ROOT / "PHASE10K8C_PAPER_ONLY_FIXTURE_VALIDATION_HELPER.md",
    REPO_ROOT / "PHASE10K8D_PAPER_ONLY_FIXTURE_READINESS_PAYLOAD_ADAPTER.md",
    REPO_ROOT / "PHASE10K8E_PAPER_ONLY_FIXTURE_EVALUATION_CONTRACT.md",
    REPO_ROOT / "PHASE10K8F_PAPER_ONLY_FIXTURE_EVALUATION_HELPER.md",
    REPO_ROOT / "PHASE10K8G_PAPER_ONLY_EVALUATION_READINESS_ADAPTER.md",
    REPO_ROOT / "PHASE10K8H_PAPER_ONLY_FIXTURE_PIPELINE_CONTRACT.md",
    REPO_ROOT / "PHASE10K8I_PAPER_ONLY_FIXTURE_PIPELINE_HELPER.md",
...
def test_prediction_testing_readiness_review_round_trip():
    valid_row = {
    ...
    assert all({"label", "value", "policy_note"} <= set(row) for row in valid_result["readiness_rows"])
