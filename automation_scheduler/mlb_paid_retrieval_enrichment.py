...
def main(argv: list[str] | None = None) -> int:
    ...
    report = build_paid_retrieval_enrichment_report(sport="mlb", base_data_dir=args.base_data_dir, allow_oxylabs=args.allow_oxylabs, allow_paid_retrieval=args.allow_paid_retrieval)
    paths = write_paid_retrieval_enrichment_report(report, sport="mlb") if args.persist else {}
