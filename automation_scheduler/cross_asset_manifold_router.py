...
from .sportsbook_manifold_mapper import map_sportsbook_full_board, map_sportsbook_market
...
def get_manifold_calibration_snapshot(*, base_data_dir: str = "data", limit: int = 25) -> dict[str, Any]:
    ...
    from .manifold_calibration import compact_manifold_calibration_report
