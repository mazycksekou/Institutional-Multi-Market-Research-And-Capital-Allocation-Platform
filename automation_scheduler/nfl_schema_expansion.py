...
def main(argv: list[str] | None = None) -> int:
    ...
    report = build_schema_expansion_report(sport="nfl", base_data_dir=args.base_data_dir)
    paths = write_schema_expansion_report(report, sport="nfl") if args.persist else {}
