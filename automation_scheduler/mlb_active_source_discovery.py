...
def main(argv: list[str] | None = None) -> int:
    ...
    report = build_active_source_discovery_log(sport="mlb", base_data_dir=args.base_data_dir, allow_oxylabs=args.allow_oxylabs, allow_paid_retrieval=args.allow_paid_retrieval)
    paths = write_active_source_discovery_log(report, sport="mlb") if args.persist else {}
