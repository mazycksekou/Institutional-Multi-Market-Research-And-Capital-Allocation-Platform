...
from .soccer_oxylabs_common import OXYLABS_SOCCER_ALLOWED_DOMAINS, OXYLABS_SOCCER_ALLOWED_SOURCE_IDS, source_spec_for


SOCCER_BLOCKED_DOMAINS = {
    "fbref.com",
...
def evaluate_soccer_oxylabs_source_policy(
    *,
    source_id: str,
    domain: str,
    transport: str,
    ...
    if normalized_domain in SOCCER_BLOCKED_DOMAINS or domain_is_blocked(normalized_domain, tuple(SOCCER_BLOCKED_DOMAINS)):
        return {
            "allowed": False,
    ...
    if source_spec is None and source_id not in OXYLABS_SOCCER_ALLOWED_SOURCE_IDS:
        return {
            "allowed": False,
    ...
    return {
        ...
        "allowed_domains": list(OXYLABS_SOCCER_ALLOWED_DOMAINS),
...
def soccer_oxylabs_policy_registry() -> dict[str, Any]:
    return {
        "ok": True,
        "status": "ok",
        "allowed_source_ids": list(OXYLABS_SOCCER_ALLOWED_SOURCE_IDS),
        "allowed_domains": list(OXYLABS_SOCCER_ALLOWED_DOMAINS),
        "blocked_domains": sorted(SOCCER_BLOCKED_DOMAINS),
