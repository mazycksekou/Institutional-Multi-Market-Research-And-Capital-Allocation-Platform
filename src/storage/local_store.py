...
TABLE_DEFINITIONS: dict[str, list[tuple[str, str]]] = {
    ...
    "historical_events": _historical_stage_columns(
        ...
        ("event_start_time_status", "TEXT"),
        ("home_team_id", "TEXT"),
        ("home_team", "TEXT"),
        ("home_team_source_name", "TEXT"),
        ("away_team_id", "TEXT"),
        ("away_team", "TEXT"),
        ("away_team_source_name", "TEXT"),
        ("venue_id", "TEXT"),
        ("venue_name", "TEXT"),
        ("venue_city", "TEXT"),
        ("venue_state", "TEXT"),
    ...
    "historical_markets": _historical_stage_columns(
        ...
        ("available_at", "TEXT"),
        ("available_at_precision", "TEXT"),
        ("market_source_methodology", "TEXT"),
        ("market_source_status", "TEXT"),
    ),
    ...
    "historical_event_participants": _historical_stage_columns(
    ...
    "historical_source_event_links": _historical_stage_columns(
    ...
    "historical_event_market_selections": _historical_stage_columns(
        ...
        ("selection_side", "TEXT"),
        ("team_id", "TEXT"),
        ("source_stage_open", "TEXT"),
        ("source_stage_close", "TEXT"),
        ("open_line_value", "REAL"),
        ("close_line_value", "REAL"),
        ("open_american_odds", "REAL"),
        ("close_american_odds", "REAL"),
        ("open_implied_probability", "REAL"),
        ("close_implied_probability", "REAL"),
        ("open_no_vig_probability", "REAL"),
        ("close_no_vig_probability", "REAL"),
        ("line_movement", "REAL"),
        ("odds_movement", "REAL"),
        ("selection_result_open", "TEXT"),
        ("selection_result_close", "TEXT"),
        ("result_margin_open", "REAL"),
        ("result_margin_close", "REAL"),
    ),
