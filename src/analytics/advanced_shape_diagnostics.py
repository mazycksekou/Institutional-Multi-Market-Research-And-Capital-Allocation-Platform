...
from src.research.causal_discovery_research import run_causal_discovery_research
from src.core.conformal_uncertainty import run_conformal_uncertainty
from src.research.contrastive_embedding_diagnostics import run_contrastive_embedding_diagnostics, run_nonlinear_embedding_diagnostics
...
def run_automation_advanced_shape_diagnostics(
    ...
    *,
    ...
    _ = persist
    return run_advanced_shape_diagnostics(
        candidate,
