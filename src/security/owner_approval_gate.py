...
from .policy import locked_safety_flags
...
__all__ = [
    ...
    "compact_owner_approval_for_audit",
]
...
def compact_owner_approval_for_audit(approval: dict[str, Any]) -> dict[str, Any]:
    return {
        ...
        "approval_denial_reason": approval.get("approval_denial_reason"),
        "approval_signature_valid": bool(approval.get("approval_signature_valid")),
        "approval_replay_detected": bool(approval.get("approval_replay_detected")),
        "approval_audit_record_present": bool(approval.get("approval_audit_record_present")),
        "approval_scope": sanitize_filename(json.dumps(_canonical_scope(dict(approval.get("approval_scope") or {})), sort_keys=True)),
    }
