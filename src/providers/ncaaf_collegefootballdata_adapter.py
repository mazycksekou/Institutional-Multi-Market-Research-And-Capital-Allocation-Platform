...
from src.data.data_source_registry import SPORT_REQUIRED_INPUTS, build_registry
...
def _safe_source_config(source: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "call_budget_level": source.get("call_budget_level") or "no_call_audit_default_tiny_sample_if_explicit",
        "max_provider_calls_default": int(source.get("max_provider_calls_default", 0) or 0),
        "max_provider_calls_hard_cap": int(source.get("max_provider_calls_hard_cap", MAX_PROVIDER_CALLS_HARD_CAP) or MAX_PROVIDER_CALLS_HARD_CAP),
...
def verify_ncaaf_cfbd_adapter(
    *,
    ...
    report = {
        ...
        "verification_phase_allowed": True,
        "requires_budget_approval": bool(config_status.get("requires_budget_approval", False)),
        "call_budget_level": config_status.get("call_budget_level"),
        "max_provider_calls_default": int(config_status.get("max_provider_calls_default", 0) or 0),
        "max_provider_calls_hard_cap": int(config_status.get("max_provider_calls_hard_cap", MAX_PROVIDER_CALLS_HARD_CAP) or MAX_PROVIDER_CALLS_HARD_CAP),
        "paid_upgrade_required": bool(config_status.get("paid_upgrade_required", False)),
        "paid_upgrade_allowed": False,
        "substantial_usage_allowed": False,
