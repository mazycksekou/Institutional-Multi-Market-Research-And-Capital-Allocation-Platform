    ...
    *,
    ...
    try:
        ...
        result = {
            ...
            "source_feature_batch_id": _normalize_text(summary.get("source_feature_batch_id")),
            "source_feature_certification_id": _normalize_text(summary.get("source_feature_certification_id")),
            "source_feature_dataset_certification_id": _normalize_text(summary.get("source_feature_dataset_certification_id")),
            "source_feature_population_summary_id": _normalize_text(summary.get("source_feature_population_summary_id")),
            "source_feature_evidence_package_id": _normalize_text(summary.get("source_feature_evidence_package_id")),
            "source_feature_batch_lineage_id": _normalize_text(summary.get("source_feature_batch_lineage_id")),
