# NCAAF Full Suite Verification Report

- full_suite_status: clean_in_deterministic_chunks_full_command_timeout_only
- original_failure_reproduced: True
- original_failure_type: timeout_only_on_monolithic_pytest_with_300_second_tool_limit
- failing_test_if_any: None
- root_cause: The full monolithic command exceeds the 5-minute command timeout. Deterministic chunks covering every tests/test_*.py file passed, so no test isolation, generated report path, unrelated dirty-file interaction, or real regression was found.
- tests_passed: 3514
- tests_failed: 0
- tests_timed_out: 1
...
## Chunks
- chunk 1: files 1-50 status=passed duration_seconds=43.75
- chunk 2: files 51-100 status=passed duration_seconds=171.04
- chunk 3: files 101-150 status=passed duration_seconds=196.73
- chunk 4: files 151-200 status=passed duration_seconds=25.01
- chunk 5: files 201-250 status=passed duration_seconds=63.86
- chunk 6: files 251-300 status=passed duration_seconds=30.53
- chunk 7: files 301-350 status=passed duration_seconds=61.98
- chunk 8: files 351-400 status=passed duration_seconds=38.55
- chunk 9: files 401-450 status=passed duration_seconds=222.28
- chunk 10: files 451-476 status=passed duration_seconds=174.23

## Tests Run
- `requested individual tests/test_ncaaf_*.py files -q`
- `python -m pytest tests/test_ncaaf*.py -q`
...
## Safety Scan
- Concrete secret value hits: []
- Raw payload hits: []
- Bad generated NCAAF flags: []
