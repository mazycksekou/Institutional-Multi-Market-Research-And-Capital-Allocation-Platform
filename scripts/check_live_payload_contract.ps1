...
$payloads = [ordered]@{}
foreach ($sport in @("nba","nfl","mlb","soccer","nhl","tennis","combat","golf","wnba","ncaab","ncaawb","ncaaf","f1","nascar","indycar","motogp","cricket","cs2","valorant","lol","dota2","cod","overwatch")) {
